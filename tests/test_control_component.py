...
def test_aerial_registry_has_seven_rules():
    """Registry must have exactly 14 rules after B1-mission-vtx-identity
    (vtx identity rule added, following payload_bay/arm/gearbox/wheels)."""
    assert len(aerial_registry) == 14
