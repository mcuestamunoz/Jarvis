...
> **Base:** tag **`v0.4.1`**. Suite viva **2858** · UI **103**.  
> **NORTH STAR:** craft montage — [lock](../.jes/artifacts/engineer_lock_craft_montage_honest_reproducible.md).  
> **PRIORIDAD AHORA:** craft montage arco **estable** — siguiente: **`B1-plate-box`** (caliper / L×W citada para quitar \*) cuando haya medida · o lateral G1.  
> **Hardware debt:** [HD-005](HARDWARE_DEBT.md#hd-005--craft-op-xing-e--gemfan-51466-3--4s-4d-follow-on).

### 📋 COLA — Craft montage (activa)
...
| **`B1-mount-standard-assist`** | CLOSED · smoke ACCEPT |
| **`B1-estimated-temporary-plate`** | CLOSED · smoked (10min/5min en uso) |
| **`B1-craft-montage-path-f`** | CLOSED · smoke ACCEPT · N1 closed |
| **`B1-layout-pack-cited`** | CLOSED · smoke ACCEPT |
| **`B1-catalog-sourced-only-purge-battery-rebind`** | CLOSED · smoke ACCEPT |
| Visor X arms (stations) → radial L-aware | CLOSED · smoke ACCEPT (Board 10min) |

### 📋 COLA — Lateral / backlog (no bloquean silueta; smoke absorbido o aplazado)

| Ítem | Estado |
|---|---|
| Situar experience B1 · Situar multi-box UX | **CLOSED** · smoke **absorbed** en walks Board craft-montage 10min/5min (2026-09-13) — reabrir solo si regresa bug UX |
| Structure A class slack | **CLOSED** · smoke absorbed (5min Structure PASS / class_compatible en arco) |
| #4 / #4b–g sourced dims + MY5 frame | **CLOSED** · catalog **in use** on live projects (formal per-SKU smoke walk optional; no bloquea cola) |
| Loose structure envelope+pose | Backlog review — no PRIORIDAD |
...
### 🟢 CLOSED — Layout pack cited B1 (`B1-layout-pack-cited`) (2026-09-13) · suite **2830** · review PASS · **smoke ACCEPT**

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_geometry_layout_pack_cited_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_layout_pack_cited_b1.md) · [review](../.jes/artifacts/implementation_review_geometry_layout_pack_cited_b1.md). Engineer smoke ACCEPT 2026-09-13 (list + clear/retype on 10min). Path F N1 closed in same cycle. Residual notes: second-pack listing · optional SKU gate · mount key-tip FN (orthogonal).

### 🟢 CLOSED — Craft montage Path F on plate B1 (`B1-craft-montage-path-f`) (2026-09-13) · suite **2830** · **smoke ACCEPT** · **N1 CLOSED**

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_geometry_craft_montage_path_f_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_craft_montage_path_f_b1.md) · [review](../.jes/artifacts/implementation_review_geometry_craft_montage_path_f_b1.md). Suggest→retype centered stack; N1 `kind=done` closed with layout-pack cycle.

### 🟢 CLOSED — Catalog sourced-only purge + battery rebind P0 (`B1-catalog-sourced-only-purge-battery-rebind`) (2026-09-13) · suite **2796** · review PASS · **smoke ACCEPT**

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_catalog_sourced_only_purge_battery_rebind_b1.md) · [report](../.jes/artifacts/implementation_report_catalog_sourced_only_purge_battery_rebind_b1.md) · [review](../.jes/artifacts/implementation_review_catalog_sourced_only_purge_battery_rebind_b1.md). Engineer smoke OK 2026-09-13.

### 🟢 CLOSED — Estimated-temporary plate B1 (`B1-estimated-temporary-plate`) (2026-09-13) · suite **2785** · review PASS · **smoke ACCEPT**

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_geometry_estimated_temporary_plate_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_estimated_temporary_plate_b1.md) · [review](../.jes/artifacts/implementation_review_geometry_estimated_temporary_plate_b1.md). Live on 10min/5min (`declara frame_plate estimada …`); Product B\* path locked. Caliper replace = `B1-plate-box` later.

### 🟢 CLOSED — Arm radial Visor + Mount tip/parse B1 (2026-09-13) · suite **2858** · UI **103** · review PASS · **smoke ACCEPT**

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_geometry_arm_radial_mount_tip_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_arm_radial_mount_tip_b1.md) · [review](../.jes/artifacts/implementation_review_geometry_arm_radial_mount_tip_b1.md). Engineer Board 10min: brazos diagonales L-aware — “se ve perfecto”. Part A keys/tips OK.

### 🟢 CLOSED — Silhouette Product B B1 Path S1 (`B1-silhouette-product-b`) (2026-09-13) · suite **2844** · review PASS · **smoke ACCEPT**

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_board_silhouette_product_b_b1.md) · [report](../.jes/artifacts/implementation_report_board_silhouette_product_b_b1.md) · [review](../.jes/artifacts/implementation_review_board_silhouette_product_b_b1.md). Engineer smoke ACCEPT 2026-09-13 on 10-min: remount esc → **silueta estimada (B\*)**.

### ⚪ SUPERSEDED — Arm radial stub FN (absorbed into combined IC above)

### 🟢 CLOSED — #4g+ Sourced frame HGLRC MY5 B1 (2026-09-13) · catalog-only · **in use / smoke absorbed**

> **IC / Report:** [IC](../.jes/artifacts/implementation_contract_geometry_sourced_frame_hglrc_my5_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_sourced_frame_hglrc_my5_b1.md). SKU `hglrc_my5_5in` on 10min+5min. Does not unlock plate-box L×W.

### 🟠 B0 HOLD — Envelope stack rule B1 (`B1-stack-rule`) (2026-09-13) · review PASS

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_geometry_stack_rule_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_stack_rule_b1.md) · [review](../.jes/artifacts/implementation_review_geometry_stack_rule_b1.md) **PASS WITH NOTES**. Path N schema-impossible (disk origin vs pose writer). Path F only after plate box. N1: prior “Path N now” IC lean corrected.

### 🟠 B0 HOLD — Main-plate box / assembly root B1 (`B1-plate-box`) (2026-09-13) · review PASS

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_geometry_plate_box_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_plate_box_b1.md) · [review](../.jes/artifacts/implementation_review_geometry_plate_box_b1.md) **PASS**. §0.1 empty; honest hold; zero code. Re-enter with filled bag + ★ path C/D/E. Estimated path covers layout until then.

### 🟢 CLOSED — Mount standard assist B1 (2026-09-13) · suite **2763** · review PASS · **smoke ACCEPT**

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_mount_standard_assist_b1.md) · [report](../.jes/artifacts/implementation_report_mount_standard_assist_b1.md) · [review](../.jes/artifacts/implementation_review_mount_standard_assist_b1.md). Engineer smoke ACCEPT on 10min (props/motors/esc/battery + FC/sensors via Spanish nouns). Residual: [FN tip/parse keys](../.jes/artifacts/field_note_mount_ambiguous_tip_parse_mismatch_b0.md) = cola **5b**.
...
### 🟢 CLOSED — Board Situar experience B1 (2026-09-12) · UI **99** · review PASS · **smoke absorbed 2026-09-13**

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_board_situar_experience_b1.md) · [report](../.jes/artifacts/implementation_report_board_situar_experience_b1.md) · [review](../.jes/artifacts/implementation_review_board_situar_experience_b1.md). Absorbed via craft-montage Board walks on 10min/5min.

### 🟢 CLOSED — Board Situar multi-box UX B1 + fix (2026-09-12) · UI **91** · fix review PASS · **smoke absorbed 2026-09-13**

> **IC / Report / Reviews:** [IC](../.jes/artifacts/implementation_contract_board_situar_multibox_ux_b1.md) · [report §Fix](../.jes/artifacts/implementation_report_board_situar_multibox_ux_b1.md) · [review](../.jes/artifacts/implementation_review_board_situar_multibox_ux_b1.md) · [review fix](../.jes/artifacts/implementation_review_board_situar_multibox_ux_b1_fix.md). Absorbed via same Board walks.
...
### 🟢 CLOSED — Structure A LEVEL A class slack B1 (2026-09-11) · suite **2742** · review PASS · **smoke absorbed**

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_structure_a_class_slack_b1.md) · [report](../.jes/artifacts/implementation_report_structure_a_class_slack_b1.md) · [review](../.jes/artifacts/implementation_review_structure_a_class_slack_b1.md). ★ Option A · `FRAME_CLASS_SLACK_IN=0.25`. Live 5min class gaps cleared in arco.

### 🟢 CLOSED — #4g Sourced frame GEPRC GEP-Racer B1 (P1 partial) (2026-09-11) · suite **2735** · catalog landed

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_geometry_sourced_frame_gep_racer_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_sourced_frame_gep_racer_b1.md) · [review](../.jes/artifacts/implementation_review_geometry_sourced_frame_gep_racer_b1.md). Catalog ready; Option B caliper still open for per-part boxes (`B1-plate-box`).

### 🟢 CLOSED — #4d Sourced motor XING-E Pro 2207 2450KV B1 (2026-09-11) · catalog landed · HD-005 OP verification remains

> **IC / Report:** [IC](../.jes/artifacts/implementation_contract_geometry_sourced_motor_xing_e_pro_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_sourced_motor_xing_e_pro_b1.md). In use; craft 51466 OP = HD-005.
...
### 🟢 CLOSED — #4f Sourced battery Tattu 2300mAh 4S 75C XT60 B1 (2026-09-11) · suite **2723** · catalog landed

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_geometry_sourced_battery_tattu_2300_4s_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_sourced_battery_tattu_2300_4s_b1.md) · [review](../.jes/artifacts/implementation_review_geometry_sourced_battery_tattu_2300_4s_b1.md). In use on live projects.

### 🟢 CLOSED — #4e Sourced prop Gemfan Hurricane MCK 51466-3 V2 B1 (2026-09-11) · suite **2718** · catalog landed

> **IC / Report / Review:** [IC](../.jes/artifacts/implementation_contract_geometry_sourced_prop_gemfan_51466_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_sourced_prop_gemfan_51466_b1.md) · [review](../.jes/artifacts/implementation_review_geometry_sourced_prop_gemfan_51466_b1.md). In use; HD-005 for craft OP.

### 🟢 CLOSED — #4c Sourced ESC SpeedyBee BLS 60A 4-in-1 B1 (2026-09-10) · suite **2713** · catalog landed

> **IC / Report:** [IC](../.jes/artifacts/implementation_contract_geometry_sourced_esc_speedybee_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_sourced_esc_speedybee_b1.md). In use on live projects.

### 🟢 CLOSED — #4b Sourced FC + GPS envelopes B1 (2026-09-10) · suite **2708** · catalog landed

> **IC / Report:** [IC](../.jes/artifacts/implementation_contract_geometry_sourced_fc_gps_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_sourced_fc_gps_b1.md). In use on live projects (FC/GPS boxes).

### 🟢 CLOSED — #4 Sourced dims B1 battery (2026-09-10) · suite **2703** · catalog landed

> **IC / Report:** [IC](../.jes/artifacts/implementation_contract_geometry_sourced_dims_b1.md) · [report](../.jes/artifacts/implementation_report_geometry_sourced_dims_b1.md). Catalog path superseded/extended by later Tattu + purge; no longer PRIORIDAD.
...
> **IC / Report:** [defer IC](../.jes/artifacts/implementation_contract_geometry_assembly_pose_b1plus_defer.md) · [report](../.jes/artifacts/implementation_report_geometry_assembly_pose_b1plus_defer.md) — **doc-only**  
> **Investigation:** [review](../.jes/artifacts/investigation_review_geometry_assembly_pose_b1plus.md) — **PASS WITH NOTES** · lean B0. Stub [pose IC](../.jes/artifacts/implementation_contract_geometry_assembly_pose_b1plus.md) → **DEFERRED**.

### 🟡 INVESTIGATION REVIEWED — Geometry assembly Pose B1+ (2026-09-07) · lean B0 Defer

> **Contract / Report / Review:** [contract](../.jes/artifacts/investigation_contract_geometry_assembly_pose_b1plus.md) · [report](../.jes/artifacts/investigation_report_geometry_assembly_pose_b1plus.md) · [review](../.jes/artifacts/investigation_review_geometry_assembly_pose_b1plus.md) — **PASS WITH NOTES** → Defer IC arriba.
