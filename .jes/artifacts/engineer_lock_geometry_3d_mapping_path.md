...
**Status:** ★ LOCKED — ordered queue. Items **1–3 CLOSED**. Rung **4 B0**. Kit / adapter / SKUs D **CLOSED**. `"cabe"` screening B1-min **CLOSED**. **Fit VERIFIED investigation OPEN** ([contract](investigation_contract_geometry_fit_verified_b0.md)).  
**Parents:**
...
The visor already draws **declared** envelopes. Rungs 1–3 **CLOSED**. Rung 4 **B0**. Kit template **B1-min CLOSED**. Rooster Included plates **B2 CLOSED**. Prop adapter ask **CLOSED** + ACCEPT. `"cabe"` screening B1-min **CLOSED**. Fit VERIFIED investigation **OPEN** ([contract](investigation_contract_geometry_fit_verified_b0.md)).
...
### 5. `"cabe"` screening — **CLOSED** @ **2540** + smoke ACCEPT

[Smoke](engineer_smoke_geometry_assembly_fit_cabe_b1.md) **ACCEPT**. Stub [fit IC](implementation_contract_geometry_assembly_fit_compare.md) remains historical (do not implement).

### 5b. Fit VERIFIED — **INVESTIGATION OPEN** (2026-09-10)

[Contract](investigation_contract_geometry_fit_verified_b0.md). Beyond AABB “screening, no verificado”. Claude = report. No IC until Engineer ★.
...
Rung **1–3 CLOSED**. Rung 4 **B0**. `"cabe"` screening **CLOSED**. Fit VERIFIED investigation **OPEN**. Package `0.4.1` · suite **2669**.
